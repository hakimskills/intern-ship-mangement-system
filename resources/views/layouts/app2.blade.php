            ...
            <div class="container-fluid d-flex justify-content-between">
                ...
                <div class="d-flex">
                    @if (Route::has('login') && Route::has('register'))
                        <a class="nav-link active mx-2" aria-current="page" href="/" style="color: #6c63ff;">
                            home
                        </a>
                    @endif
                    @if (Route::has('login'))
                        @auth
                            @if(Auth::user()->type=='user')
                                <a class="nav-link active mx-2" aria-current="page" href="/home" style="color: #6c63ff">
                                    <i class="fa-solid fa-user" style="color: #6c63ff;"></i> {{Auth::user()->name}} {{Auth::user()->last_name }}
                                </a>
                            @endif
                            @if(Auth::user()->type=='admin')
                                <a class="nav-link active mx-2" aria-current="page" href="/admin/home" style="color: #6c63ff">
                                    <i class="fa-solid fa-user" style="color: #6c63ff;"></i> {{Auth::user()->name}} {{Auth::user()->last_name }}
                                </a>
                            @endif
                            @if(Auth::user()->type=='manager')
                                <a class="nav-link active mx-2" aria-current="page" href="/manager/home"style="color: #6c63ff">
                                    <i class="fa-solid fa-user" style="color: #6c63ff;"></i> {{Auth::user()->name}} {{Auth::user()->last_name }}
                                </a>
                            @endif
                        @endauth
                    ...
                    @guest
                            ...
                            <a class="nav-link mx-2" href="{{ route('login') }}" style="color: #6c63ff">
                                Login
                            </a>


                            <a class="nav-link mx-2" href="{{ route('register') }}"style="color: #6c63ff;">
                               {{ __('Register') }}
                            </a>
